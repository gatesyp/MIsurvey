	...
	<div class="container">
		...
		<form action="survey.php" method="post">
			...
			<div class="btn-group" data-toggle="buttons">
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[4] ?></label>  

				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[5] ?> </label> <br>
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[9] ?></label>  

				<input type="checkbox" name="response[]" value="1"autocomplete="off" /> <label> <?php echo $choicesText[10]; ?></label>

				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[11] ?></label> <br>
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[14] ?></label> 
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[17] ?></label> <br>
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[20] ?></label> 

				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[21] ?> </label> 

				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[22] ?></label>

				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[23] ?></label> 
