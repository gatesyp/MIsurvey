	...
	<div class="container">
		...
		<form action="survey.php" method="post">
			...
			<div class="btn-group" data-toggle="buttons">
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[6] ?></label> <br>
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[13] ?></label> <br>
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[20] ?></label> <br>
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[24] ?></label> 
