	...
	<div class="container">
		...
		<form action="survey.php" method="post">
			...
			<div class="btn-group" data-toggle="buttons">
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[3] ?></label> <br>
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[7] ?></label> <br>
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[15] ?> </label> <br>
