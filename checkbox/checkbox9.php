	...
	<div class="container">
		...
		<form action="survey.php" method="post">
			...
			<div class="btn-group" data-toggle="buttons">
				...
				<input type="checkbox" name="response[]" value="1"utocomplete="off"/> <label> <?php   echo $choicesText[2]?> </label> <br>
				...
				<input type="checkbox" name="response[]" value="1"autocomplete="off"/> <label> <?php  echo $choicesText[8] ?></label> <br>
